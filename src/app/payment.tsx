...
const createStyles = (c: ThemeColors) =>
  ...
  header: { backgroundColor: c.navy, alignItems: 'center', paddingBottom: 24, borderBottomLeftRadius: 26, borderBottomRightRadius: 26 },
  ...
  headerAmount: { color: c.success, fontSize: 38, fontWeight: '900', marginTop: 4 },
  ...
  webWrap: { flex: 1, backgroundColor: c.navy },
  loadingOverlay: { ...StyleSheet.absoluteFillObject, alignItems: 'center', justifyContent: 'center', gap: 14, backgroundColor: c.navy, zIndex: 2 },
  loadingText: { color: '#cfd8ee', fontSize: 14, fontWeight: '600' },
  center: { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: c.bg, gap: 10, paddingHorizontal: 40 },
  verifyIcon: { width: 72, height: 72, borderRadius: 24, backgroundColor: c.successBg, alignItems: 'center', justifyContent: 'center', marginBottom: 8 },
  verifyTitle: { fontSize: 18, fontWeight: '800', color: c.text },
  verifyText: { fontSize: 14, color: c.textMuted, fontWeight: '500', textAlign: 'center' },
});
