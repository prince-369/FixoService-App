  ...
  return (
    <View style={styles.wrap}>
      <View style={styles.iconStack}>
        ...
        <View style={styles.iconCore}><Ionicons name="search" size={18} color={colors.white} /></View>
      </View>
      <View style={{ flex: 1 }}>
...
const createStyles = (c: ThemeColors) =>
  ...
  ripple: { position: 'absolute', width: 40, height: 40, borderRadius: 20, backgroundColor: c.orange },
  iconCore: { width: 38, height: 38, borderRadius: 19, backgroundColor: c.orange, alignItems: 'center', justifyContent: 'center' },
  msg: { fontSize: 14, fontWeight: '800', color: c.text },
  dots: { color: c.orange },
